...
@if( count($pay_rent) >=1 )
                        ...
                        <div style="display: none;">
                            ...
                            <input type="text" value='{{ $pay_rent1->fname  }}'  name="fname">
                            <input type="text" value='{{ $pay_rent1->mname  }}'  name="mname">
                            <input type="text" value='{{ $pay_rent1->lname  }}'  name="lname">
                            <input type="text" value='{{ $pay_rent1->email  }}'  name="email">
                            <input type="text" value='{{ $pay_rent1->dob  }}'  name="dob">
                            <input type="text" value='{{ $pay_rent1->gender  }}'  name="gender">
                            <input type="text" value='{{ $pay_rent1->kindred  }}'  name="kindred">
                            <input type="text" value='{{ $pay_rent1->village  }}'  name="village">
                            <input type="text" value='{{ $pay_rent1->town  }}'  name="town">
                            <input type="text" value='{{ $pay_rent1->country  }}'  name="country">
                            <input type="text" value='{{ $pay_rent1->state  }}'  name="state">
                            <input type="text" value='{{ $pay_rent1->state1  }}'  name="state1">
                            <input type="text" value='{{ $pay_rent1->lga  }}'  name="lga">
                            <input type="text" value='{{ $pay_rent1->lga1  }}'  name="lga1">
                            <input type="text" value='{{ $pay_rent1->office_address  }}'  name="office_address">
                            <input type="text" value='{{ $pay_rent1->passport  }}'  name="passport">
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                value='{{ $pay_rent1->phone1  }}'  >
                            </div>

                            <div class="col-md-3">
                                <input type="text" class="form-control" placeholder="Phone 2" name="phone2" value='{{ $pay_rent1->phone2  }}' >
                            </div>
                    ...
                    <br/><h2 align="center" style="font-size:27px; font-weight:bold;">Residential Information </h2><hr/>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea class="form-control"  style='height:130px' name="resident_address" required placeholder="Enter full Addres Including the State and Country" >{{ $pay_rent1->resident_address  }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" placeholder="e.g. Lagos toll gate"  style="font-weight:bold;" class="form-control" name="landmark" required value='{{ $pay_rent1->landmark  }}'  >
                            </div>
                        </div>
                        ...
                        <br/><br/>    <h2 align="center" style="font-size:27px; font-weight:bold;">Landlord Information </h2><hr/>
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="" name="landlord_name"  required  value='{{ $pay_rent1->landlord_name  }}'  >
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" placeholder="" name="landlord_acc_name" required value='{{ $pay_rent1->landlord_acc_name  }}' >
                            </div>
...
@endif
  ...
  <div class="form-group row">
                            <label class="col-md-3 col-form-label text-md-right"> Which Date do you want to start?: <span style="color:red;">*</span></label>
                              ...
                              <div class="col-md-3">
                                <input type="date" class="form-control" min="{{ date('Y-m-d') }}" placeholder="Which Date do you want to start?" name="start_date" required >
                            </div>
