	...
	<div class="page-title-section">
		<div class="container">
			<div class="pull-left page-title">
				<a href="#">
				<h2> Air Space Purchase form  </h2>
				</a>
			</div>
			<div class="pull-right breadcrumb">
				<a href="#">home</a><span class="fa fa-arrow-circle-right sep"></span><a href="#"> Air Space Purchase form  </a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="col-md-3 contact-info">
			...
			<div class="inner-wrapper">
				...
				<h1><b>AIR SPACE REGISTRATION FORM</b></h1>
                ...
                <hr/>
				<form  method="POST" action="{{ route('airspace.store') }}" style="font-size:15px;" enctype="multipart/form-data">
                    ...
                    <div style="padding:15px; background-color:#fce4ec; display:none;" id="suv">
                        ...
                        <div class="form-group row" id='sale'>
                            <label class="col-md-5 col-form-label text-md-right">Price (<i>How Much do you want to sell your Land air Space?</i>) <span style="color:red;">*</span></label>
                ...
                <div class="form-group col-md-3">
                      <label> Image 6<span class="text-danger">*</label>
                          <input style='font-size:5px !important;' name="image6" accept='.gif, .jpg,.png' type="file" id="input-file-now" required class="dropify" data-max-file-size="1M"/>
                            ...
                            <div class="col-md-12">
                                <input class="form-check-input" type="checkbox" name="rtfeddvd" required id="space">

                                <label class="form-check-label" for="space" >
                                   Accept That you are willing to co-own the property with the Buyer  
                                </label>
                            </div>
