...
<table class="table table-sm table-stripped table-bordered">
  <tr>
    ...
    <td>
        ...
        <?php 
        $start_date = date('D jS F Y',strtotime($mysaving->saving_start_date) );
        date( $start_date , strtotime("$mysaving->saving_interval_no $mysaving->saving_interval s") );
...
{{-- $pay_amt = 1.2  *  $mysaving->saving_interval_amt;   --}}
     ?>   
  ...
  <tr>
    ...
    <td>
     <b> Your answer is <b> {{ $mysaving->buy_for_u }}  </b>
       ...
       <a href="#!" class="btn btn-sm btn-danger">Payments Details</a>
