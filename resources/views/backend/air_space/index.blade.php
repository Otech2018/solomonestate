...
@section('content')
   ...
   @include('backend.inc.top_nav')
      ...
      <div class="card shadow-lg">
        <div class="card-body">
            <h5 class="card-title">List of {{ $type }} Air Space Request  </h5>
                        ...
                        @if($LandSale->status !=0)
                            <tr>
                                ...
                                <td><?php echo date('d-M-Y',strtotime($LandSale->created_at)); ?> </td>
                                 <td> 
                                  <a href="{{ route('airspace.show', $LandSale->id) }}" class="btn btn-sm btn-primary"> <i class="fa fa-eye"></i></a>
                                ...
                                <form id="act{{$LandSale->id}}" action="{{ route('airspace.update',$LandSale->id ) }}" method="POST" class="d-none">
                                    @csrf
