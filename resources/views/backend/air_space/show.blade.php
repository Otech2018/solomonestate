...
@section('content')
   ...
   @include('backend.inc.top_nav')
      ...
      <div class="card shadow-lg">
        <div class="card-body">
            <h1 align='center' class="card-title">Request Details (Air Space)</h1><hr/>
         ...
         <div>   
            <br/><br/>
          <center>
            <img src="{{ asset('storage/land_space/'.$LandSales->passport)}}"  width="250px" height="250px"/>
          </center>
...
<br/><br/>
            ...
            <tr><td><b> <i class="fa fa-info-circle"></i> Status:</b></td><td>  
               ...
               @if($LandSales->status==1) <span class="badge badge-success">Solved</span> 
...
<h1 align="center" style="font-size: 22px; font-weight:bold;"> <br/><br/> ID CARD</h1><hr/>
            ...
            <tr><td><b> <i class="fa fa-cogs"></i> LAND DOCUMENTS AVALIABLE  :</b></td><td>  <i>{{$LandSales->land_doc_avaliable}}</i></td></tr>
            <tr><td><b> <i class="fa fa-cogs"></i> SURVEY DETAILS  : <br/> Is the Land Surveyed? : {{$LandSales->land_surveyed}} </b></td>
              <td> 
              <b style="color:green;"> PLAN NUMBER: </b><i>{{$LandSales->plan_number}}</i> <br/>
              <b style="color:green;"> BEACON NUMBER: </b><i>{{$LandSales->beacon_number}}</i><br/>
             <b style="color:green;">  SURVEYOR: </b><i>{{$LandSales->surveyor}}</i><br/>
              <b style="color:green;"> SURVEYOR ADDRESS: </b><i>{{$LandSales->surveyor_address}}</i>
             </td></tr>
...
<h1 align="center" style="font-size: 22px; font-weight:bold;">Land Images</h1><hr/>
          <div class="row justify-content-center">
              <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->cover_image)}}"  width="100%" />
         <h2>Cover Image </h2><br/><br/>
       </div>
       <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->image1)}}"  width="100%" />
         <h2>Image 1</h2><br/><br/>
       </div>

       <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->image2)}}"  width="100%" />
         <h2>Image 2</h2><br/><br/>
       </div>


       <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->image3)}}"  width="100%" />
         <h2>Image 3</h2><br/><br/>
       </div>


       <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->image4)}}"  width="100%" />
         <h2>Image 4</h2><br/><br/>
       </div>


       <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->image5)}}"  width="100%" />
         <h2>Image 5</h2><br/><br/>
       </div>


       <div class="col-md-4">
         <img src="{{ asset('storage/land_space/'.$LandSales->image6)}}"  width="100%" />
         <h2>Image 6</h2><br/><br/>
       </div>
