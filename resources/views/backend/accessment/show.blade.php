...
@section('content')
   ...
   @include('backend.inc.top_nav')
      ...
      <div class="card shadow-lg">
        <div class="card-body">
            <h2 style="font-size:35px; align:center;"> {{$assessment->topic}} </h2>
         ...
         @include('layouts.messages')    
            ...
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalCenter"> <i class="fa fa-comment"></i> Comment</a>
          </div>
